...
sudo ln /usr/local/share/gnome-terminal-symlink/gterm-alacritty.sh /usr/bin/gnome-terminal
sudo chmod 755 /usr/local/share/gnome-terminal-symlink/gterm-alacritty.sh
